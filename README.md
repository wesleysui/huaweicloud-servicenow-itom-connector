...
RDS (both have clear AWS-documented CI classes, `cmdb_ci_cloud_load_balancer`
/ `cmdb_ci_cloud_database`), reusing the pagination/retry/caching
groundwork above. Route Table/NAT Gateway/VPC Peering Discovery is
deliberately not planned — see the productization row above.
