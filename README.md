...
**Next planned round:** resource-type expansion for Discovery — RDS
(standard CMDB CI class `cmdb_ci_cloud_database`; ELB Discovery is now
done, see the productization row above), reusing the
